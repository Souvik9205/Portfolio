    ...
    return (
        <section id="contact" className="relative text-stone-100 bg-stone-500 body-font">
            ...
            <div className="lg:w-2/3 md:w-1/2 bg-gray-900 rounded-lg overflow-hidden sm:mr-10 p-10 flex items-end justify-start relative">
                ...
                src="https://www.google.com/maps/embed/v1/place?q=Madhyamgram+Chowmatha+Yatri+Pratikshalay,+Netaji+Nagar,+Madhyamgram,+Kolkata,+West+Bengal,+India&key=AIzaSyBFw0Qbyq9zTFTd-tUY6dZWTgaQzuU17R8"
                />
